...
function SignInPage() {
  ...
  return (
    ...
    <form 
        ...
        <label htmlFor="email" className='block text-gray-700 font-bold mb-2'>Enter email:</label>
        <input 
            type="email"
            id="email"
            name="email"
        ...
        <div className='flex justify-between text-sm sm:text-base mb-10'>
            <p>Don't have account? 
                <Link href="/sign-up" className='text-orange-dark hover:text-orange-light ml-1'>Register</Link>
            </p>
            <p>
